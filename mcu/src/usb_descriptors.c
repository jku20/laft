...
uint8_t static desc_configuration[] = {
    ...
    TUD_VENDOR_DESCRIPTOR(ITF_NUM_VENDOR, 0, BULK_OUT_ENDPOINT_DIR,
                          BULK_IN_ENDPOINT_DIR, ENDPOINT_BULK_SIZE),
};

// String descriptors
char const *string_desc_arr[] = {
    [STRID_LANGID] =
        (const char[]){0x09, 0x04}, // Supported language ID - English (US)
